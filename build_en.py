...
<link rel="alternate" hreflang="zh-CN" href="{DOMAIN}/zh{path}">
...
<nav><div class="wrap nav-in">
  ...
  <a class="lang-switch" href="/zh{path}" title="中文版">中文</a>
...
# hand-off: favicon/robots/sitemap 由 finalize.py 统一生成(双语)
(ROOT/"_pages_en.json").write_text(json.dumps(pages))
print(f"[en] built {len(pages)} pages → public/")
